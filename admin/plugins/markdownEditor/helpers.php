<?php
// Render the markdown editor's toolbar. Single source of truth for the
// PHP-emitted DOM; the JS counterpart at editor.js's
// window.lpMarkdownEditor.toolbarHtml() emits byte-identical output for
// dynamic callers (e.g. eventList admin.js's renderCard).

if (!function_exists('markdown_editor_toolbar_html')) {
    function markdown_editor_toolbar_html(): string {
        return <<<'HTML'
