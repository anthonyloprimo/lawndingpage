...
lawnding_register_hook('head_assets', function (): void {
    $href = function_exists('lawnding_asset_url')
        ? lawnding_asset_url('res/scr/plugin-style.php?plugin=telegram')
        : '/res/scr/plugin-style.php?plugin=telegram';
...
lawnding_register_hook('header_auth_area', function (array $ctx): void {
    ...
    $avatarUrl = function_exists('lawnding_asset_url')
        ? lawnding_asset_url('res/scr/plugin-endpoint.php?plugin=telegram&endpoint=avatar')
        : '/res/scr/plugin-endpoint.php?plugin=telegram&endpoint=avatar';
