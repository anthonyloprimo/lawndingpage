...
$seedDir = realpath(__DIR__ . '/../resources/seed-instance/public/res/data');
test_assert($seedDir !== false && is_dir($seedDir), 'resources/seed-instance/public/res/data exists');
